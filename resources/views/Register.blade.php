...
<html
  ...
  data-assets-path="{{asset('assets/template')}}/assets/"
  ...
  <head>
    ...
    <title>Register kasir Delia</title>
             ...
             @endif
              ...
              <form id="formAuthentication" class="mb-3" action="{{route('actionregister')}}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="username" name="nama_lengkap" placeholder="Masukan Nama Lengkap Anda" autofocus />
                </div>
                <div class="mb-3">
