          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('pelanggan') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>                
                <div data-i18n="user">Data Pelanggan</div>
            </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{route('actionlogout')}}" class="menu-link" target="_blank">
                  ...
                  <div class="card-body">
                      <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="username" value="{{ old('name') ?? $users->username }}" required autocomplete="name" autofocus>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="photo" type="file" class="form-control-file @error('photo') is-invalid @enderror" name="foto">
