                ...
                <div class="authentication-wrapper authentication-basic container-p-y">
                  <div class="authentication-inner">
                    <div class="card">
                      ...
                      <form id="formAuthentication" class="mb-3" action="{{route('actionprodukkasir')}}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="harga" name="harga_awal" placeholder="Harga Produk" />
                        </div>
                        <div class="mb-3">
